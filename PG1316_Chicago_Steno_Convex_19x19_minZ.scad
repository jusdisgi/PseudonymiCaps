...
//
mirror([0,0,0])keycap(
  keyID  = 0, //Currently only 0 or 1 work. Refer to KeyParameters Struct
...
//  BotWid, BotLen, TWDif, TLDif,  keyh, WSft, LSft   XSkew,  YSkew, ZSkew,   WEx,  LEx,  CapR0i, CapR0f, CapR1i, CapR1f, CapREx, StemEx
    ...
    [18.4,  18.4,   5.6, 	  5,     3.9,    0,    -1,    7,      -0,    -0,      2,    2,    .1,     3,      .1,     3,      2,       2], //Chicago Steno R2x 1u
    [18.4,  18.4,   5.6, 	  5,     3.6,    0,    .0,    0,      -0,    -0,      2,    2,    .1,     3,      .1,     3,      2,       2], //Chicago Steno R3x 1u
