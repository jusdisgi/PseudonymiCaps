...
// >>> PRESET: 19.05x19.05 (MX spacing, PG/Choc stem) <<<  (standalone; just render. Master = Subliminal_Contradiction.scad)
...
unit_x = 19.05;
unit_y = 19.05;
gap    = 0.99;   // 19.05x19.05 (MX spacing, PG/Choc stem): cap = pitch - gap
