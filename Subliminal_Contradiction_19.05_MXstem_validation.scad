...
// >>> PRESET: 19.05 MX-stem VALIDATION vs original SC <<<  (standalone; just render. Master = Subliminal_Contradiction.scad)
...
unit_x = 19.05;
unit_y = 19.05;
gap    = 0.99;   // 19.05 MX-stem VALIDATION vs original SC: cap = pitch - gap

stemType = "MX";  // "PG1316S" | "Choc" | "MX"  (PG1316S also fits Choc v1)
...
//uW, uL, TWDif, TLDif, keyh, WSft, LSft, XSkew, YSkew, ZSkew, WEx, LEx, CapR0i, CapR0f, CapR1i, CapR1f, CapREx, StemEx
  [1, 1, 5.5, 4.0, 4.77, 0, 0,   2.1, 0.0, 0, 2, 2, 1, 5, 1, 3.5, 2, 2], //0 R3 home  (near flat)
  [1, 1, 5.5, 4.0, 5.29, 0, 0, -11.8, 0.0, 0, 2, 2, 1, 5, 1, 3.5, 2, 2], //1 R2 top   (leans back)
  [1, 1, 5.5, 4.0, 5.83, 0, 0,   6.7, 0.0, 0, 2, 2, 1, 5, 1, 3.5, 2, 2], //2 R4 bottom(leans fwd)
  [1, 1, 5.5, 4.0, 4.86, 0, 0,   0.0, 0.0, 0, 2, 2, 1, 5, 1, 3.5, 2, 2], //3 R3 uniform/flat
  [1, 1, 5.5, 4.0, 5.71, 0, 0, -11.7, 6.9, 0, 2, 2, 1, 5, 1, 3.5, 2, 2], //4 R2 left-reach
  [1, 1, 5.5, 4.0, 5.20, 0, 0,   2.5, 5.3, 0, 2, 2, 1, 5, 1, 3.5, 2, 2], //5 R3 left-reach
  [1, 1, 5.5, 4.0, 6.30, 0, 0,   6.7, 3.3, 0, 2, 2, 1, 5, 1, 3.5, 2, 2], //6 R4 left-reach
];
